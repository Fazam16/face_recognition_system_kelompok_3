...
bgImage = tk.PhotoImage(file="D:\\Tugas Kuliah\\Tugas kuliah semester 5\\KB\\face_recognition_system_kelompok_3\\anotherFile\\background.png")
...
judul = tk.Label(frame, text="Face and Emotion Recognition", font=("Times New Roman", 20), bg='#fee3cb')
judul.place(x=330, y=50)

BStart = tk.Button(frame, text ="Rekognisi Wajah", command=videostream, width=25, height=1)
BStart.place(x=400, y = 600)

BRecord = tk.Button(frame, text ="Record Wajah", command=videostreamRecord, width=25, height=1)
BRecord.place(x=200, y=600)

BQuit = tk.Button(frame, text ="Stop", command = stop, width=25, height=1, fg='red')
BQuit.place(x=600, y=600)

copyRight = tk.Label(frame, text="@Copyright by Kelompok 3 KB L2", font=("Times New Roman", 10), underline=0, bg='#fee3cb')
copyRight.place(x=800, y=650)
